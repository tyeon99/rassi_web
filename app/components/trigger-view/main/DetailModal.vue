<template>
  <div
    class="modal-overlay animate__animated animate__faster detailModal"
    :class="{ 'animate__fadeIn': isModalAni, 'animate__fadeOut': !isModalAni }" 
    @click="closeDetailModal"
  >
    <div
      class="modal-content animate__animated animate__faster detailModal"
      :class="{
    ...
    >
      ...
      <div ref="tabContainer" class="modal__tab">
        <div 
          class="tab-indicator"
          :style="{
...
const emit = defineEmits(['close-detailModal'])
