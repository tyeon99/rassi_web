  ...
  >
    ...
    >
      <div class="offcanvas-close">
        <button @click="closeAllStyleOffcanvas">
      ...
      <div class="offcanvas-body allStyleOffcanvas">
        <AllStyleContent />
      </div>
...
const emit = defineEmits(['close-allStyleOffcanvas'])

const closeAllStyleOffcanvas = () => {
  emit('close-allStyleOffcanvas')
}
</script>