  ...
  >
    ...
    >
      <div class="offcanvas-close">
        <button @click="closeIntroOffcanvas">
      ...
      <div class="offcanvas-body introOffcanvas">
        <div class="txt-wrap">
          <div class="txt-group">
            <div class="title">
              <strong>추천 스타일 패스</strong>
              <span>현재 시장에서 좋은 성과가 기대되는 스타일 패스</span>
            </div>
            <div class="box">
              <div class="p-group">
                <p>
                  하루에 2개씩 1M·3M 기대수익률이 높을 것으로 예상되는 추천 스타일 패스와 Pick 5 종목을 제공합니다.<br /><br />

                  추천 스타일 패스는 강한 주가 흐름, 개선되는 실적, 긍정적인 수급 등 여러 종목 스타일이 함께 나타나는 종목을 중심으로 선별합니다.<br /><br />
          ...
          <div class="txt-group">
            <div class="title">
              <strong>스타일 패스</strong>
              <span>매일 오전 업데이트되는 종목 분석 리포트</span>
            </div>
            <div class="box">
              <div class="p-group">
                <p>
                  10개의 종목스타일을 종합 분석해 종목과 연관된 23가지 스타일 패스 유형으로 제공하며, 종목을 쉽고 직관적으로 이해할 수 있도록 도와줍니다.<br /><br />

                  스타일 패스에 해당하는 종목을 스코어 순으로 확인할 수 있으며, 스타일의 상세 설명과 활용 방법, 구성 종목의 분석 내용을 함께 제공합니다. 최근 1개월 동안 높은 수익률을 기록한 TOP 5 종목도 확인할 수 있습니다.
                </p>
              </div>
              <div class="p-group">
                <strong>활용 방법</strong>
                <p>
                  스타일 패스는 종목의 현재 특징을 이해하고, 유사한 투자 패턴의 종목을 찾는 데 활용할 수 있습니다.<br /><br />
            ...
            <div class="box">
              <div class="p-group">
                <p>
                  ...
                  또한 해당 종목이 속한 스타일 패스를 함께 제공하여, 비슷한 특징을 가진 종목과 스타일의 상세 설명, 활용 방법까지 함께 확인할 수 있습니다.
                </p>
              </div>
            </div>
          </div>
...
const emit = defineEmits(['close-introOffcanvas'])

const closeIntroOffcanvas = () => {
  emit('close-introOffcanvas')
}
</script>