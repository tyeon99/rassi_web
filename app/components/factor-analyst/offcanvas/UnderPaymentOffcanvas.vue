    ...
    >
      ...
      <div class="offcanvas-body">
        ...
        <div class="body-title">
          <strong>스타일⁺를 시작하세요!</strong>
          <p>종목을 더 깊이 분석하는 방법<br /> 스타일⁺와 함께하세요.</p>
          <span>라씨 매매비서 금감원 등록 번호 : 00-01-01</span>
        </div>

        <div class="body-box">
          <div class="box-title">스타일⁺에서 이용하세요!</div>
          <div class="box-txt">
            <div class="txt">
              ...
              <p>10개 종목 스타일과<br />23개 스타일⁺로 종목 분석</p>
            </div>
            <div class="txt">
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="txt">
              ...
              <p>종목 스타일별 분석 데이터와<br />추천 스타일⁺ 성과 추적 제공</p>
            </div>
          </div>
        </div>

        <div class="body-select">
          <div class="select-title">원하는 방법으로 스타일⁺를 이용해 보세요.</div>
          <div class="select-box">
            ...
            >
              ...
              <div class="box-txt">
                프리미엄 2개월 이상 이용 고객에게 제공되는 스타일⁺ 무료 혜택을 예약해 보세요.<br />
            ...
            >
              ...
              <div class="box-txt">
                기다리지 않고 지금 바로 스타일⁺를 이용해보세요.
                종목 분석과 추천 스타일⁺를 바로 확인할 수 있습니다.
              </div>
            </button>
          </div>
        </div>
      ...
      <div class="offcanvas-footer">
        <button>
          {{ selectedOption === 0 ? '무료 이용 알림 예약하기' : '스타일⁺ 시작하기' }}
        </button>
      </div>
    </div>
  </div>
