<template>
  <div class="content-section">
    <div class="title">
      <span>가진 재산에 비해 가격이 얼마나 저평가 되어 있는가?</span>
      <h1>장부가치수익률(BM) 점수는?</h1>
    </div>

    <div class="gray-box">
      <div class="box-title">
        <strong>과거 나와 비교한 BM 점수는?</strong>
        <p>BM점수는 자본총계/시가총액 (=1/PBR)로 자산가치 점수예요.</p>
      </div>
...
const itemList = ref([
  {
    title: '같은 업종과 비교하면?',
    subTitle: '자산 기준 BM를 같은 업종 회사들과 비교',
    isScore: false,
    ranges: [
