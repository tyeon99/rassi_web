<template>
  <div class="content-section">
    ...
    <div class="list">
      <div class="gpa-title">
        <p>최근 1개월 이동평균선에서 얼마나 벗어나 <br />있을까?</p>
        <span>86.2</span>
      </div>
...
const itemList = ref([
  {
    title: '전체 시장과 비교하면?',
    subTitle: '전체 종목 중 SK하이닉스보다 이동평균선과의 괴리(변동성 대비 하락 정도)가 작았던 종목의 비율',
    isScore: false,
    ranges: [
  ...
  {
    title: '같은 업종과 비교하면?',
    subTitle: '반도체 업종 안에서 SK하이닉스보다 이동평균선과의 괴리(변동성 대비 하락 정도)가 작았던 종목의 비율',
    isScore: false,
    ranges: [
